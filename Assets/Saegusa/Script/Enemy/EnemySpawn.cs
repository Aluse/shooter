...
<<<<<<< HEAD
        ...
        StartCoroutine(Corutine_Spawn(71, Enemy2, 1));
        StartCoroutine(Corutine_Spawn(71, Enemy2, 2));
        StartCoroutine(Corutine_Spawn(71, Enemy1, 3));
        StartCoroutine(Corutine_Spawn(71, Enemy1, 4));
        StartCoroutine(Corutine_Spawn(71, Enemy3, 1));
        StartCoroutine(Corutine_Spawn(72, Enemy1, 2));
        StartCoroutine(Corutine_Spawn(72, Enemy1, 2));
        StartCoroutine(Corutine_Spawn(72, Enemy6, 3));
        StartCoroutine(Corutine_Spawn(72, Enemy5, 3));
        StartCoroutine(Corutine_Spawn(72, Enemy3, 2));
        StartCoroutine(Corutine_Spawn(73, Enemy1, 1));
        StartCoroutine(Corutine_Spawn(73, Enemy2, 4));
        StartCoroutine(Corutine_Spawn(73, Enemy2, 2));
        StartCoroutine(Corutine_Spawn(73, Enemy4, 3));
        StartCoroutine(Corutine_Spawn(73, Enemy1, 1));
        StartCoroutine(Corutine_Spawn(74, Enemy5, 1));
        StartCoroutine(Corutine_Spawn(74, Enemy6, 4));
        StartCoroutine(Corutine_Spawn(75, Enemy1, 3));
        StartCoroutine(Corutine_Spawn(75, Enemy1, 3));
        StartCoroutine(Corutine_Spawn(75, Enemy2, 1));
        StartCoroutine(Corutine_Spawn(75, Enemy2, 4));
        StartCoroutine(Corutine_Spawn(76, Enemy1, 1));
        StartCoroutine(Corutine_Spawn(76, Enemy2, 4));
        StartCoroutine(Corutine_Spawn(78, Enemy5, 2));
        StartCoroutine(Corutine_Spawn(78, Enemy6, 3));
        StartCoroutine(Corutine_Spawn(79, Enemy4, 1));
        StartCoroutine(Corutine_Spawn(79, Enemy3, 3));
        StartCoroutine(Corutine_Spawn(79, Enemy1, 4));
        StartCoroutine(Corutine_Spawn(80, Enemy1, 0));
        StartCoroutine(Corutine_Spawn(80, Enemy3, 1));
        StartCoroutine(Corutine_Spawn(80, Enemy2, 2));
        StartCoroutine(Corutine_Spawn(81, Enemy1, 1));
        StartCoroutine(Corutine_Spawn(81, Enemy1, 2));
        StartCoroutine(Corutine_Spawn(82, Enemy1, 3));
        StartCoroutine(Corutine_Spawn(82, Enemy2, 0));
        StartCoroutine(Corutine_Spawn(83, Enemy1, 1));
        StartCoroutine(Corutine_Spawn(83, Enemy3, 2));
        StartCoroutine(Corutine_Spawn(84, Enemy1, 3));
        StartCoroutine(Corutine_Spawn(84, Enemy4, 4));
        StartCoroutine(Corutine_Spawn(85, Enemy1, 2));
        StartCoroutine(Corutine_Spawn(88, Enemy2, 3));
        StartCoroutine(Corutine_Spawn(88, Enemy2, 4));
        StartCoroutine(Corutine_Spawn(88, Enemy3, 0));
        StartCoroutine(Corutine_Spawn(90, Enemy1, 1));
        StartCoroutine(Corutine_Spawn(90, Enemy2, 0));
        StartCoroutine(Corutine_Spawn(90, Enemy3, 3));
        StartCoroutine(Corutine_Spawn(90, Enemy4, 2));
        StartCoroutine(Corutine_Spawn(92, Enemy1, 4));
        StartCoroutine(Corutine_Spawn(92, Enemy2, 0));
        StartCoroutine(Corutine_Spawn(92, Enemy4, 3));
        StartCoroutine(Corutine_Spawn(92, Enemy6, 2));
        StartCoroutine(Corutine_Spawn(94, Enemy4, 1));
        StartCoroutine(Corutine_Spawn(94, Enemy3, 3));
        StartCoroutine(Corutine_Spawn(94, Enemy2, 2));
...
=======
        StartCoroutine(Corutine_Spawn(1, BoosEnemy, 2));
        //StartCoroutine(Corutine_Spawn(1, Enemy1, 0));
        //StartCoroutine(Corutine_Spawn(2, Enemy1, 1));
        //StartCoroutine(Corutine_Spawn(3, Enemy1, 2));
        //StartCoroutine(Corutine_Spawn(4, Enemy1, 3));
